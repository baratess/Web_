...
import "./HikingProductPage.css";
import HikingProductItem from "./HikingProductItem";

const HikingProductPage = () => {
        ...
        <div className="fishpage-container">
          <div className="fishpage-product-wrapper fishpage-product-carousel">
            {products.map((product) => {
              if (product.category.includes("66e067d91aa4fcfcbaf922d7"))
                return (
                  <HikingProductItem productItem={product} key={product._id} />
                );
            })}
          </div>
        </div>
...
export default HikingProductPage;
