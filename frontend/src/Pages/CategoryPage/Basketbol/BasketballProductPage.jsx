...
import "./BasketballProductPage.css";
import BasketballProductItem from "./BasketballProductItem";
        ...
        <div className="fishpage-container">
          <div className="fishpage-product-wrapper fishpage-product-carousel">
            {products.map((product) => {
              if (product.category.includes("67042df5e0205141f9a507f2"))
                return (
                  <BasketballProductItem
                    productItem={product}
                    key={product._id}
                  />
                );
